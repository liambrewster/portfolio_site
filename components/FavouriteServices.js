...
export default function FavouriteServices() {
	// TODO: add services for main page
	return (
		<div className='bg-[#F1F1F1] -mt-40 dark:bg-gray-900'>
			<div className='max-w-6xl mx-auto'>
				<header className='flex flex-col md:flex-row justify-between items-center pt-40 mx-10 md:my-20 lg:my-0'>
					...
					>
						<a className='mb-20 md:mb-0 px-8 py-4 rounded-md bg-white shadow-lg text-xl font-semibold flex flex-row space-x-4 items-center dark:text-gray-700'>
							...
							<p>View all Collaborations</p>
						</a>
					</Link>
				</header>

				{/* Grid starts here */}
				{/* TODO: add my favourite services */}
				<div className='grid md:grid-cols-3 gap-8 lg:-mt-8 pb-40'>
					...
					<a
						href='#'
						className='w-full col-span-3 sm:col-span-1  gap-2 grid object-cover'
					>
						<div className='relative overflow-hidden shadow-2xl'>
							...
							/>
							<h1 className='absolute top-10 left-10 text-gray-50 font-bold text-xl bg-sky-500 rounded-md px-2'>
								Operational Reviews and Enhancements
							</h1>
							<h1 className='absolute bottom-10 left-10 text-gray-50 font-bold text-xl'>
								03
							</h1>
